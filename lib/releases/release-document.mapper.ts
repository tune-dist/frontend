...
export function mapMongoReleaseToDetail(document: MongoReleaseDocument): ReleaseDetailResponse {
  ...
  return {
    ...
    warning: document.warning === true,
    audioConsent: document.audioConsent === true,
    coverArtConsent: document.coverArtConsent === true,
    audioWarningMessage: document.audioWarningMessage ?? null,
    coverArtWarnings: document.coverArtWarnings ?? [],
    ...
    distributionIssueResubmittedAt: document.distributionIssueResubmittedAt ?? null,
    distributionIssueResolvedAt: document.distributionIssueResolvedAt ?? null,
    draftReviewNote: document.draftReviewNote ?? null,
    draftReviewResubmittedAt: document.draftReviewResubmittedAt ?? null,
...
export function mapListItemToFlatRelease(item: ReleaseListItem): Record<string, unknown> {
  return {
    ...
    coverArtWarnings: item.coverArtWarnings ?? [],
    distributionIssueNote: item.distributionIssueNote,
    distributionIssueDetectedAt: item.distributionIssueDetectedAt,
    distributionIssueResubmittedAt: item.distributionIssueResubmittedAt,
    distributionIssueResolvedAt: item.distributionIssueResolvedAt,
    draftReviewNote: item.draftReviewNote,
    draftReviewResubmittedAt: item.draftReviewResubmittedAt,
...
export function mapDetailToFlatRelease(detail: ReleaseDetailResponse): Record<string, unknown> {
  ...
  return {
    ...
    warning: detail.warning === true,
    audioConsent: detail.audioConsent === true,
    coverArtConsent: detail.coverArtConsent === true,
    audioWarningMessage: detail.audioWarningMessage ?? null,
    coverArtWarnings: detail.coverArtWarnings ?? [],
    ...
    distributionIssueResubmittedAt: detail.distributionIssueResubmittedAt ?? null,
    distributionIssueResolvedAt: detail.distributionIssueResolvedAt ?? null,
    draftReviewNote: detail.draftReviewNote ?? null,
    draftReviewResubmittedAt: detail.draftReviewResubmittedAt ?? null,
