    ...
    <section className="py-24 sm:py-32 bg-muted/10">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="text-center mb-16 lg:mb-20">
          <h2 className="text-4xl sm:text-5xl font-bold font_heading mb-6 tracking-tight">The Ktarolib Pipeline</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
          {steps.map((step, idx) => (
            <div
              key={idx}
              className="bg-muted/20 p-10 rounded-[2.5rem] border border-border/40 relative group overflow-hidden hover:bg-muted/40 transition-colors shadow-sm hover:shadow-xl hover:border-cyan-500/20"
            >
              ...
              <step.icon className="h-12 w-12 text-cyan-400 mb-8" />
