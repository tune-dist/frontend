...
export default function GuidesPage() {
  const subtitle = "Actionable playbooks for independent artists and record labels."
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 font_heading tracking-tight text-white">
              <span className='animated-gradient'>Music Distribution Guides</span> - In-Depth Resources for Independent Artists
            </h1>
            {subtitle && (
